      ...
      <div class="menu">
        ...
        <div class="dropdown " @click="toggleDropdown" :class="{ 'open': isDropdownOpen }">
            ...
            <div class="dropdown-content" v-if="isDropdownOpen" @click.stop>
                ...
                <router-link to="/junior-records"><span class="material-icons">groups</span><span class="text">Junior High</span></router-link>
                <router-link to="/senior-records"><span class="material-icons">groups</span><span class="text">Senior High</span></router-link>
            </div>
            </transition>
